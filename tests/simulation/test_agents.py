...
class TestAgents(unittest.TestCase):
    ...
    def test_get_next_node(self):
        #Tests if current node can find a new node
    ...
    def test_red_light(self):
        #Tests if light is coherent in both node and light itself
        test_light = Light(0, Traffic(), (1, 1), False, "Light")
    ...
    def test_get_light_from_lane(self):
        #Tests if the sensor can find the activity of a light
        test_model = Traffic()
    ...
    def test_get_light_from_lane_no_light(self):
        #Tests if the lane doesnt have a light, it doesn't show that it has a light
        test_model = Traffic()
